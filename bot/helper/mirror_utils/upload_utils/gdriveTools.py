...
class GoogleDriveHelper:
    ...
    def __create_directory(self, directory_name, parent_id):
        file_metadata = {
            "name": directory_name,
            "description": "@Mirrordrive Exclusive ❤",
    ...
    def clone(self, link):
        ...
        try:
            ...
            if mime_type == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                msg += f'\n\n<b>⌈➳ </b>{get_readable_file_size(self.transferred_size)}'
                msg += '\n\n<b>⌈➳ </b>Folder'
                ...
                buttons = ButtonMaker()
                buttons.buildbutton("gDrive", durl)
                if mime_type is None:
                    mime_type = 'File'
                msg += f'\n\n<b>⌈➳ </b>{get_readable_file_size(int(meta.get("size", 0)))}'
                msg += f'\n\n<b>⌈➳ </b>{mime_type}'
                if INDEX_URL is not None:
    ...
    def count(self, link):
        ...
        try:
            ...
            if mime_type == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                msg += f'\n\n<b>⌈➳ </b>{get_readable_file_size(self.__total_bytes)}'
                msg += '\n\n<b>⌈➳ </b>Folder'
                msg += f'\n<b>⌈➳</b>{self.__total_folders}'
            else:
